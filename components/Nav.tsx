...
export default function Nav() {
  return (
    // Safari 26 derives the status-bar tint by sampling this element's
    // background-color and backdrop-filter, so the alpha here also decides
    // how solid the strip above the header looks on iOS.
    <header className="fixed inset-x-0 top-0 z-50 border-b border-line bg-[rgba(10,11,9,0.92)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] pt-[env(safe-area-inset-top)] backdrop-blur-md">
